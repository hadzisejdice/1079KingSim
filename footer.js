...
document.addEventListener("DOMContentLoaded", () => {
  const footerHTML = `
    ...
    ">
      ...
      <p style="margin:0;">
        © 2026 1079KingSim — Created by Cro_Baby_Shark, with contributions from the community.<br>Special thanks for support to BladeXtreme and 1079# LoL<br>All rights reserved.
      </p>
    </footer>
  `;
